...
<header>	
	<ul class="ul2">
	<li><a href="index.php"><input class="favorite styled" type="button" value=" Acceuil "></a></li>
...
<li><a href="connexion.php"><input class="favorite styled" type="button" value=" Connexion "></a></li>
